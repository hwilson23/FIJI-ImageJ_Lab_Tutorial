...
#@ Float lateral_res(label="Lateral Pixel Size (μm/pixel)", style="format:0.0000", min=0.0000, value=0.065)
#@ Float axial_res(label="Axial Pixel Size (μm/pixel)", style="format:0.0000", min=0.0000, value=0.1)
